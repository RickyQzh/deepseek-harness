...
This crate does not register product plugins. Callers `register` setups on a `PluginRegistry` by YAML `name`.

## Known Limitations and Deferred Work

- Product plugin setups (`product_registry()`) are not in this crate.
