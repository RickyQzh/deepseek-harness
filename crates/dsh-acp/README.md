...
ACP stdio adapter for the DeepSeek Harness Rust host. This crate is not the SDK JSON-RPC server (`dsh-sdk-jsonrpc-server`). Stdout carries NDJSON ACP frames only.
